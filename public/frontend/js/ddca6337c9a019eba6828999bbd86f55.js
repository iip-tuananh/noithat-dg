                        ...
                        (i.marginLeft = i.marginTop = 0),
                            (n < a ? "contain" === e["object-fit"] : "cover" === e["object-fit"])
                                ? ((l = r * n),
                                  ...
                                  (i.height = r + "px"),
                                  "left" === e["object-position-x"] ? (i.marginLeft = 0) : "right" === e["object-position-x"] ? (i.marginLeft = Math.round(s - l) + "px") : (i.marginLeft = Math.round((s - l) / 2) + "px"))
                                : ((c = s / n),
                                  (i.width = s + "px"),
                                        ...
                                        value: function (t) {
                                            if (!this._breakpoint) {
                                                ...
                                                if ((this.affixedType != e || t) && e) {
                                                    ...
                                                    for (var r in (o.eventTrigger(this.sidebar, s), "STATIC" === e ? o.removeClass(this.sidebar, this.options.stickyClass) : o.addClass(this.sidebar, this.options.stickyClass), n.outer))
                        ...
                        typeof (n = function (t) {
                            ...
                            return (
                                ...
                                (t.fn.scrollTo = function (o, s, r) {
                                    "object" == typeof s && ((r = s), (s = 0)), "function" == typeof r && (r = { onAfter: r }), "max" === o && (o = 9e9), (r = t.extend({}, e.defaults, r)), (s = s || r.duration);
                                                ...
                                                t.each(r.axis.split(""), function (t, i) {
                                                    ...
                                                    if (l)
                                                        (p[s] = l[o] + (c ? 0 : g - u.offset()[o])),
                                                            r.margin && ((p[s] -= parseInt(d.css("margin" + n), 10) || 0), (p[s] -= parseInt(d.css("border" + n + "Width"), 10) || 0)),
                                                            (p[s] += f[o] || 0),
                                        ...
                                        if ((o = i.split("_")).length > 1) {
                                            ...
                                            if (s.length > 0) {
                                                ...
                                                "replaceWith" === r
                                                    ...
                                                    ? s.is("img")
                                                        ? s.attr("src", n)
                                                        : s.replaceWith(t("<img>").attr("src", n).attr("class", s.attr("class")))
                                                    : s.attr(o[1], n);
                                            }
                        ...
                        (t = {
                            ...
                            for (var a in this.waypoints[s]) {
                                ...
                                d.element !== d.element.window && (m = d.adapter.offset()[r.offsetProp]),
                                    ...
                                    (u = !c && !h),
                                    !g && c && h ? (d.queueTrigger(r.backward), (o[d.group.id] = d.group)) : ((!g && u) || (g && r.oldScroll >= d.triggerPoint)) && (d.queueTrigger(r.forward), (o[d.group.id] = d.group));
                            }
                        }
                        return (
                    ...
                    n.options.functionBefore.call(n.$el, n.$el, function () {
                        if (n.enabled && null !== n.Content) {
                            ...
                            if ("hidden" !== n.Status) {
                                ...
                                if (
                                    ((n.$tooltip = t('<div class="tooltipster-base ' + n.options.theme + '" style="' + h + " " + u + " " + d + " " + c + '"><div class="tooltipster-content"></div></div>')),
                                    r() && n.$tooltip.addClass(a),
                                    n._content_insert(),
                                    n.$tooltip.appendTo("body"),
                                    n.reposition(),
                                    n.options.functionReady.call(n.$el, n.$el, n.$tooltip),
                                    r() ? (n.$tooltip.addClass(a + "-show"), n.options.speed > 0 && n.$tooltip.delay(n.options.speed), n.$tooltip.queue(o)) : n.$tooltip.css("display", "none").fadeIn(n.options.speed, o),
                                    n._interval_set(),
                    ...
                    if (0 !== t("body").find(i.$tooltip).length) {
                        ...
                        function D(i, n) {
                            s.offset.top - t(e).scrollTop() - a - P - 12 < 0 && n.indexOf("top") > -1 && (A = i),
                                s.offset.top + s.dimension.height + a + 12 + P > t(e).scrollTop() + t(e).height() && n.indexOf("bottom") > -1 && ((A = i), (j = s.offset.top - a - P - 12));
                        }
                        if ("top" == A) {
                        ...
                        if (
                            ("top-left" == A && ((T = s.offset.left + I), (j = s.offset.top - a - P - 12), O(), D("bottom-left", "top-left")),
                            "top-right" == A && ((T = s.offset.left + s.dimension.width + I - r), (j = s.offset.top - a - P - 12), O(), D("bottom-right", "top-right")),
                            "bottom" == A && ((Q = s.offset.left + r - (s.offset.left + s.dimension.width)), (T = s.offset.left - Q / 2 + I), (j = s.offset.top + s.dimension.height + P + 12), O(), D("top", "bottom")),
                            "bottom-left" == A && ((T = s.offset.left + I), (j = s.offset.top + s.dimension.height + P + 12), O(), D("top-left", "bottom-left")),
                            "bottom-right" == A && ((T = s.offset.left + s.dimension.width + I - r), (j = s.offset.top + s.dimension.height + P + 12), O(), D("top-right", "bottom-right")),
                            "left" == A)
                        ) {
                        ...
                        if (
                            ("right" == A &&
                                ...
                                T + r > o && _ < 0
                                    ? ((M = 2 * parseFloat(i.$tooltip.css("border-width"))),
                                      ...
                                      (L = s.offset.top + a - (s.offset.top + s.dimension.height)),
                                      (j = s.offset.top - L / 2 - P))
                                    : T + r > o && ((T = s.offset.left - I - r - 12), (n = "right"))),
                            i.options.arrow)
                        ) {
                            ...
                            if (
                                ...
                                "bottom" == A || "bottom-left" == A || "bottom-right" == A
                                    ? ((W = parseFloat(i.$tooltip.css("border-top-width"))), (N = i.$tooltip.css("border-top-color")))
                                    : "left" == A
                                    ? ((W = parseFloat(i.$tooltip.css("border-right-width"))), (N = i.$tooltip.css("border-right-color")))
                                    : "right" == A
                                    ? ((W = parseFloat(i.$tooltip.css("border-left-width"))), (N = i.$tooltip.css("border-left-color")))
                                    : ((W = parseFloat(i.$tooltip.css("border-bottom-width"))), (N = i.$tooltip.css("border-bottom-color")));
                            W > 1 && W++;
                            var H = "";
                            if (0 !== W) {
                                var V = "",
                                ...
                                -1 !== F.indexOf("bottom")
                                    ...
                                    : -1 !== F.indexOf("right") && (V = "margin-left: -" + Math.round(W) + "px;"),
                    ...
                    return (
                        this.each(function () {
                            ...
                            o ? (l ? (i = !0) : h && console.log('Tooltipster: one or more tooltips are already attached to this element: ignoring. Use the "multiple" option to attach more tooltips.')) : (i = !0),
                                i && ((r = new n(this, e[0])), o || (o = []), o.push(r.namespace), t(this).data("tooltipster-ns", o), t(this).data(r.namespace, r)),
                                s.push(r);
                        }),
                        l ? s : this
                    );
        ...
        if (
            ...
            jQuery(window).on("scroll", function () {
                if (!Object(n.c)()) {
                    ...
                    t >= e.outerHeight() && (t <= m ? (e.addClass("stuck"), s.removeClass("sticky-hide-on-scroll--active")) : (e.removeClass("stuck"), s.addClass("sticky-hide-on-scroll--active"))),
                    ...
                    (o.prototype._checkForIntersections = function () {
                        ...
                        this._observationTargets.forEach(function (o) {
                            var s = o.element,
                                ...
                                u = (o.entry = new n({ time: t.performance && performance.now && performance.now(), target: s, boundingClientRect: r, rootBounds: i, intersectionRect: h }));
                            ...
                            for (var o, s, r, l, h, u, d, p, f = a(i), m = c(i), g = !1; !g; ) {
                                ...
                                if (
                                    ...
                                    v &&
                                        ...
                                        (p = l - r),
                                        !(f = (d = (u = Math.min(o.right, s.right)) - h) >= 0 && p >= 0 && { top: r, bottom: l, left: h, right: u, width: d, height: p })))
                                )
                                    break;
                                m = c(m);
                            }
                        ...
                        switch (n) {
                            ...
                            case "element":
                                (y = g * o),
                                    ...
                                    void 0 !== i.dataset.parallaxFade && (i.style.opacity = o ? ((e = 1 - v), e * (2 - e)).toFixed(2) : null);
                        }
                })(t);
        }
        function r(t) {
                            ...
                            return (function (t) {
                                t.classList.add("parallax-active"),
                                    (!document.querySelector("body").classList.contains("parallax-mobile") && /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) ||
                                        (t.classList && t.dataset && (n.push({ element: t, type: r(t) }), s(n[n.length - 1])));
                            })(e);
                        });
                });
    },
                ...
                e.addClass("current-dropdown"),
                    (function (e) {
                        ...
                        if (a) {
                            ...
                            i.css(s(s({ width: n }, c && { right: -(v.right - y.right) }), !c && { left: v.left - y.left }));
                        }
                        if (r) {
                            var b = document.body,
                                ...
                                C = b.clientWidth;
                            i.css(s(s({ width: C }, c && { right: -(w.right - x.right) - 15 }), !c && { left: w.left - x.left - 15 }));
                        }
                        if (a || r) {
                            var k = null;
                            if (
                            ...
                            jQuery("li.nav-single-page").before(c),
                                ...
                                jQuery(a)
                                    ...
                                    .on("click", function (t) {
                                        ...
                                        e &&
                                            (setTimeout(function () {
                                                jQuery.scrollTo("a[name=" + e + "]", { duration: 500, axis: "y", offset: -i });
                                            }, 0),
        ...
        Flatsome.behavior("youtube", {
            attach: function (t) {
                ...
                0 !== r.length &&
                    ...
                    e.getElementById(n) || (((o = e.createElement(i)).id = n), (o.src = "https://www.youtube.com/player_api"), s.parentNode.insertBefore(o, s)));
            },
        });
    },
    ,
                    ...
                    i.waypoint({
                        handler: function (t) {
                            if (!jQuery(this.element).hasClass("active")) {
                                ...
                                new o(i.get(0), e, { decimalPlaces: 0, duration: 4 }).start(), i.addClass("active");
                            }
                        },
                        offset: "100%",
                    });
