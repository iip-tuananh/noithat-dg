                ...
                function (t, e) {
                    ...
                    for (c.method = t, c.arg = e; ; ) {
                        ...
                        if (
                            ...
                            ((n = (function t(e, n) {
                                ...
                                return "throw" === (o = h(o, e.iterator, n.arg)).type
                                    ...
                                    : (o = o.arg)
                                    ? o.done
                                        ? ((n[e.resultName] = o.value), (n.next = e.nextLoc), "return" !== n.method && ((n.method = "next"), (n.arg = r)), (n.delegate = null), y)
                                        : o
                        ...
                        if (((u = s), "normal" === (n = h(i, a, c)).type)) {
                            if (((u = c.done ? p : f), n.arg !== y)) return { value: n.arg, done: c.done };
    ...
    return (
        ...
        (j.prototype = {
            ...
            complete: function (t, r) {
                if ("throw" === t.type) throw t.arg;
                return (
                    "break" === t.type || "continue" === t.type ? (this.next = t.arg) : "return" === t.type ? ((this.rval = this.arg = t.arg), (this.method = "return"), (this.next = "end")) : "normal" === t.type && r && (this.next = r), y
                );
            },
            finish: function (t) {
